...
import static com.watabou.pixeldungeon.PixelDungeon.brightness;
import static com.watabou.pixeldungeon.PixelDungeon.soundFx;
...
public class WndSettings extends Window {
	...
	public WndSettings( boolean inGame ) {
		...
		if (inGame) {
			...
			btnBrightness.checked( brightness() );
			add( btnBrightness );
